...
export default function InfiniteMenu({ items = [] }) {
  ...
  useEffect(() => {
    if (location.state && (location.state as { fromPictureFrame?: boolean }).fromPictureFrame) {
  ...
  return (
    <div className={`w-full h-full ${shouldAnimate ? 'animate-zoom-in' : ''}`} style={{ position: 'relative', width: '100%', height: '100vh' }}>
